...
<div class="pub-page-header">
  <div class="container">
    <h1>Aloqa</h1>
    <p>Savollaringiz bormi? Quyidagi kanallardan birortasi orqali murojaat qiling</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="why-grid">
      ...
      <a href="tel:{{ preg_replace('/\s+/', '', $siteSettings->phone) }}" class="why-card" style="text-decoration:none">
        ...
        <div class="why-title">Telefon</div>
      ...
      <div class="why-card">
        ...
        <div class="why-title">Manzil</div>
        <div class="why-text">{{ $siteSettings->address ?: "Toshkent, O'zbekiston" }}</div>
      </div>
      ...
      <div class="why-card">
        ...
        <div class="why-title">Ish vaqti</div>
        <div class="why-text">{{ $siteSettings->work_time_display ?: 'Dush–Shan 9:00–18:00' }}</div>
      </div>
